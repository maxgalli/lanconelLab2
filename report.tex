...
\begin{figure}[!htb]
  \centering
  \subfloat[][] {\includegraphics[width=0.45\textwidth]{plots/mm_fwhm_noblur.png}}
  \subfloat[][] {\includegraphics[width=0.45\textwidth]{plots/mm_fwhm_blur.png}}\\
  \subfloat[][] {\includegraphics[width=0.45\textwidth]{plots/kev_fwhm_noblur.png}}
  \subfloat[][] {\includegraphics[width=0.45\textwidth]{plots/kev_fwhm_blur.png}}
